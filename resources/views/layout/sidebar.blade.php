    ...
    <div class="sidebar-wrapper active">
      ...
      <div class="sidebar-menu">
        <ul class="menu">
          ...
          <li class="sidebar-item">
            <a class="sidebar-link" href="/barangreski">
          ...
          <li class="sidebar-item">
            <a class="sidebar-link" href="/bagianreski">
          ...
          <li class="sidebar-item">
            <a class="sidebar-link" href="/kategorireski">
          ...
          <li class="sidebar-item">
            <a class="sidebar-link" href="/petugasreski">
          ...
          <li class="sidebar-item">
            <a class="sidebar-link" href="/pengeluaranreski ">
